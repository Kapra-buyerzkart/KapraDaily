...
const OrderSuccessScreen = () => {
  ...
  const displayDeliverySlot =
    deliverySlot ||
    (orderDetails?.deliverySlotDate
      ? `${orderDetails.deliverySlotDate} | ${orderDetails.deliverySlotTime}`
      : null);
  const addressObj = address || orderDetails?.shippingAddress;
  const displayAddress = address
    ? address
    : addressObj
    ? `${addressObj.addLine1 || ''} ${addressObj.addLine2 || ''}, ${
        addressObj.landmark || ''
      }, ${addressObj.district || ''}`
        .replace(/,\s*,/g, ',')
        .replace(/^,|,$/g, '')
        .trim()
    : '';
  logger.log('aaaaaaaaa', address, orderDetails);
        ...
        >
          ...
          <View style={styles.successSection}>
            <Image
              ...
              source={require('../assets/images/success-two.png')}
            />
            <View style={styles.thankYouContainer}>
              <Text style={styles.thankYouText}>Thank You!</Text>
              <Text style={styles.thankYouTextTwo}>
          ...
          <View style={styles.orderCard}>
            ...
            <View style={styles.detailRow}>
              ...
              <View style={styles.detailBadge}>
                <MaterialCommunityIcons
                  name={
                    displayPayment?.toUpperCase() === 'COD'
                      ? 'cash'
                      : 'cellphone'
                  }
                  size={wp('3.5%')}
            ...
            <View style={styles.detailRow}>
              ...
              <View style={styles.deliveryBadge}>
                <Ionicons
                  name={
                    displayDeliveryMode === 'express' ? 'flash' : 'time-outline'
                  }
                  size={wp('3.5%')}
                  color="#F25000"
                />
