        ...
        >
          ...
          <View style={styles.pendingSection}>
            ...
            <View style={styles.statusContainer}>
              ...
              <Text style={styles.statusTextTwo}>
                We are verifying your payment with the bank. This usually takes
                a few minutes.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.infoCard}>
            ...
            <View style={styles.stepRow}>
              <View style={[styles.stepDot, { backgroundColor: '#F2994A' }]} />
              <Text style={styles.stepText}>
                You can track the status in the "My Orders" section.
              </Text>
            </View>
            <View style={styles.stepRow}>
              <View style={[styles.stepDot, { backgroundColor: '#F2994A' }]} />
              <Text style={styles.stepText}>
                If payment fails, it will be refunded to your original method.
              </Text>
            </View>
          </View>
          ...
          <Text style={styles.footerNote}>
            In case of any issues, please contact our support team from the
            order details page.
          </Text>
        </ScrollView>
      </LinearGradient>
